  ...
  return (
    <section id="top" className="relative overflow-hidden bg-[var(--color-bg)]">
      <div className="mx-auto grid max-w-6xl gap-12 px-6 pb-20 pt-16 md:grid-cols-[1.1fr_0.9fr] md:pb-28 md:pt-24">
        <div>
          <p className="mb-5 inline-flex items-center gap-2 rounded-full border border-[var(--color-line)] bg-white px-3 py-1 font-mono text-xs uppercase tracking-wider text-[var(--color-teal)]">
            Revenue cycle management
          </p>

          <h1 className="font-[family-name:var(--font-display)] text-4xl font-semibold leading-[1.08] tracking-tight text-[var(--color-navy)] sm:text-5xl md:text-6xl">
          ...
          <dl className="mt-14 grid max-w-lg grid-cols-3 gap-6 border-t border-[var(--color-line)] pt-6">
            {heroStats.map((stat) => (
              <div key={stat.label}>
...
function HeroClaimCard() {
  ...
  return (
    <div className="w-full max-w-sm rounded-2xl border border-[var(--color-line)] bg-white p-6 shadow-[0_20px_60px_-25px_rgba(11,61,92,0.35)]">
      ...
      <div className="mt-6 rounded-lg bg-[var(--color-teal-light)] p-4">
